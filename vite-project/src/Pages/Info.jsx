        ...
        <div className="container mx-auto px-4 lg:flex lg:items-center lg:justify-between">
          <div className="lg:w-1/2">
            ...
            <div className="mt-8 flex gap-4">
              <Link
                to="/Home"
                className="inline-flex items-center px-6 py-3 text-base font-medium text-white bg-blue-700 rounded-lg shadow-md hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600"
              >
                Volver
                <svg
              ...
              <Link
                to="/Login"
                className="inline-flex items-center px-6 py-3 text-base font-medium text-gray-900 border border-gray-300 rounded-lg shadow-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-500"
              >
                Iniciar sesión
              </Link>
            </div>
